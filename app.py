...
def detect_wake_words():
    ...
    speech = LiveSpeech(
        hmm=os.path.join(
            r'/Users/soumya/Desktop/JARVIS.S/.venv/lib/python3.9/site-packages/pocketsphinx/model/en-us', 'en-us'),
        dic=os.path.join(
            r'/Users/soumya/Desktop/JARVIS.S/.venv/lib/python3.9/site-packages/pocketsphinx/model/en-us', 'cmudict-en-us.dict'),
        kws=kws_list_path
    )
    print("Wake me")
